...
//
//			// Classe buffered resume em uma pequena memoria
			...
			listaMouse.add(mouse3);
				...
				try (BufferedWriter escrever = new BufferedWriter(new FileWriter("Mouses.txt"))) {
					for (Mouse mouse : listaMouse) 
						escrever.write(mouse.toString()); // do string para "rodar" a lista de mouses que contem as informações de cada mouse.
				}
